...
function answerBoss(value){
  if(screen!=='BOSS'||bossTask.locked)return;bossTask.locked=true;const correct=value===bossTask.question.answer;if(correct)bossTask.correct++;
