...
const FILES=['./','./index.html','./style.css','./app.js','./game.js','./input.js','./scene.js','./manifest.webmanifest','./vendor/phaser.min.js','./assets/station.png','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
...
// Activate fixed assets immediately. The app reloads only at a safe lobby/end screen;
